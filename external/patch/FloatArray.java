...
public final class FloatArray extends TornadoNativeArray {
    ...
    public FloatArray(int numberOfElements) {
        ...
        // 🚀 FLOATARRAY-LONGFIX START - Fix integer overflow for large tensor allocations >2GB
        // Original: segmentByteSize = numberOfElements * FLOAT_BYTES + arrayHeaderSize;
        // Problem: int arithmetic overflows before assignment to long variable
        // Solution: Cast to long before multiplication to prevent overflow
        segmentByteSize = (long)numberOfElements * FLOAT_BYTES + arrayHeaderSize;
        // 🚀 FLOATARRAY-LONGFIX END
