...
public class TaskGraph implements TaskGraphInterface {
    ...
    /**
     * BUFFERS-ONLY-FIX: Free only GPU buffers without device reset
     * Enables surgical memory cleanup avoiding warmup conflicts
     */
    @Override
    public void freeBuffersOnly() {
        taskGraphImpl.freeBuffersOnly();
    }
